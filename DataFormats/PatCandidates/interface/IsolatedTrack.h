...
namespace pat {
  ...
  public:
    IsolatedTrack()
        : LeafCandidate(0, LorentzVector(0, 0, 0, 0)),
          ...
          associatedEBRecHits_(),
          associatedEERecHits_(),
          associatedHBHERecHits_(),
          pfLepOverlap_(false),
          pfNeutralSum_(0.),
          dz_(0.),
          dxy_(0.),
    ...
    explicit IsolatedTrack(const PFIsolation& iso,
                           ...
                           float ecalEnergy,
                           float hcalEnergy,
                           EBRecHitCollection associatedEBRecHits,
                           EERecHitCollection associatedEERecHits,
                           HBHERecHitCollection associatedHBHERecHits,
                           bool pfLepOverlap,
                           float pfNeutralSum,
        ...
        : LeafCandidate(charge, p4, Point(0., 0., 0.), id),
          ...
          associatedEBRecHits_(associatedEBRecHits),
          associatedEERecHits_(associatedEERecHits),
          associatedHBHERecHits_(associatedHBHERecHits),
    ...
    const EBRecHitCollection& associatedEBRecHits()  const { return associatedEBRecHits_; }
    const EBRecHitCollection& associatedEERecHits()  const { return associatedEERecHits_; }
    const HBHERecHitCollection& associatedHBHERecHits() const { return associatedHBHERecHits_; }
  ...
  protected:
    ...
    EBRecHitCollection   associatedEBRecHits_;
    EERecHitCollection   associatedEERecHits_;
    HBHERecHitCollection associatedHBHERecHits_;
    bool pfLepOverlap_;
    float pfNeutralSum_;
